...
public class Recipe {
    ...
    private ArrayList<Recipe> preparations;
    ...
    public Recipe(String name, boolean prep) {
        id = 0;
        this.name = name;
    ...
    public ArrayList<Recipe> getPreparations() {
    ...
    public void addPreparation(boolean prep) {
        this.preparation = prep;

...
public class Menu {
    ...
    public ObservableList<MenuItem> freeItems;
    ...
    public static Menu loadMenuById(int id_menu) {
        ...
        PersistenceManager.executeQuery(query, rs -> {
            ...
            menu.setOwner(User.loadUserById(rs.getInt("owner_id")));
            menu.sections = Section.loadSectionsFor(menu.getId());
            menu.freeItems = MenuItem.loadItemsFor(menu.getId(), 0);
        });
        return menu;
    }
